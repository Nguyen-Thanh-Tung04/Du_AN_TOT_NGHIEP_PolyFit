...
<section class="section section-xl bg-default text-md-left">
    <div class="container">
        ...
        @endphp
        <div class="ec-trackorder-inner p-2  order-item-detail {{ $index >= 4 ? 'd-none' : '' }}">
        ...
        @if (count($order->orderItems) > 4)
        <div class="text-center mt-3">
            <button id="see-more-order" class="btn btn-link">Xem thêm <i style="font-size: 12px;" class="fas fa-chevron-down"></i></button>
        </div>
        @endif
...
@section('scripts')
<script>
    $('#see-more-order').on('click', function() {
        $('.order-item-detail.d-none').removeClass('d-none');
        $(this).hide();
    });
