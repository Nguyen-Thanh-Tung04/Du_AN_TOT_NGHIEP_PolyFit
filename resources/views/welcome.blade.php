            ...
            <div class="row">
                ...
                <div class="col-md-12 text-center">
                    <ul class="ec-pro-tab-nav nav justify-content-center">
                        ...
                        <li class="nav-item"><a class="nav-link" data-bs-toggle="tab"
                                href="{{ url('/product_detail') }}tab-pro-for-women">Sản phẩm giảm giá</a></li>
                        <li class="nav-item"><a class="nav-link" data-bs-toggle="tab"
                                href="{{ url('/product_detail') }}tab-pro-for-child">Sản phẩm xả hàng</a></li>
                    </ul>
                </div>
                <!-- Tab End -->
            </div>
                                    ...
                                    <div class="ec-product-ds">
                                            <div class="ec-product-image">
                                                <a href="{{ url('/product_detail') }}" class="image">
                                                    <img class="pic-1"
                                                        src="{{ asset('theme/client/assets/images/product-image/18_1.jpg') }}"
                                                        alt="" />
                                                </a>
                                            ...
                                            <div class="ec-product-body">
                                                ...
                                                <h3 class="ec-title"><a href="{{ url('/product_detail') }}">{{$value->product_id}}</a></h3>
                                                <div class="ec-price"><span>{{number_format($value->listed_price, 0)}} VNĐ</span> {{number_format($value->sale_price, 0)}} VNĐ</div>
                                                <a class=" ec-add-to-cart" href="{{ url('/product_detail') }}">Thêm giỏ
                                                    hàng</a>
                                            </div>
                                    </div>
                                    @endforeach
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6">
                                    ...
                                    <div class="ec-product-ds">
                                        ...
                                        <div class="ec-product-image">
                                            <a href="{{ url('/product_detail') }}" class="image">
                                                <img class="pic-1"
                                                    src="{{ asset('theme/client/assets/images/product-image/6_1.jpg') }}"
                                                    alt="" />
                                            </a>
                                        </div>
                                        <div class="ec-product-body">
                                            ...
                                            <h3 class="ec-title"><a href="{{ url('/product_detail') }}">{{$value->product_id}}</a></h3>
                                            <div class="ec-price">{{number_format($value->listed_price, 0)}} VNĐ</div>
                                            <a class=" ec-add-to-cart" href="{{ url('/product_detail') }}">Thêm giỏ
                                                hàng</a>
                                        </div>
                                    </div>
                                ...
                                {{-- <div class="col-lg-3 col-md-6 col-sm-6">
                                    ...
                                    <div class="ec-product-ds">
                                        <div class="ec-product-image">
                                            <a href="{{ url('/product_detail') }}" class="image">
                                                <img class="pic-1"
                                                    src="{{ asset('theme/client/assets/images/product-image/3_1.jpg') }}"
                                                    alt="" />
                                            </a>
                                        ...
                                        <div class="ec-product-body">
                                            ...
                                            <h3 class="ec-title"><a href="{{ url('/product_detail') }}">Leather purse for
                                                    women</a></h3>
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6">
                                    ...
                                    <div class="ec-product-ds">
                                        <div class="ec-product-image">
                                            <a href="{{ url('/product_detail') }}" class="image">
                                                <img class="pic-1"
                                                    src="{{ asset('theme/client/assets/images/product-image/4_1.jpg') }}"
                                                    alt="" />
                                            </a>
                                        ...
                                        <div class="ec-product-body">
                                            ...
                                            <h3 class="ec-title"><a href="{{ url('/product_detail') }}">Hool hat for
                                                    men</a></h3>
                ...
                <div class="col-lg-3">
                    <ul class="ec-cat-tab-nav nav">
                        <li class="cat-item"><a class="cat-link active" data-bs-toggle="tab"
                                href="{{ url('/product_detail') }}tab-cat-1">
                                <div class="cat-icons"><img class="cat-icon"
                                        src="{{ asset('theme/client/assets/images/icons/cat_1.png') }}"
                                        alt="cat-icon"><img class="cat-icon-hover"
                                        src="{{ asset('theme/client/assets/images/icons/cat_1_1.png') }}" alt="cat-icon">
                                </div>
                                <div class="cat-desc"><span>Quần áo</span><span>440 Sản phẩm</span></div>
                            </a></li>
                        <li class="cat-item"><a class="cat-link" data-bs-toggle="tab"
                                href="{{ url('/product_detail') }}tab-cat-2">
                                <div class="cat-icons"><img class="cat-icon"
                                        src="{{ asset('theme/client/assets/images/icons/cat_2.png') }}"
                                        alt="cat-icon"><img class="cat-icon-hover"
                                        src="{{ asset('theme/client/assets/images/icons/cat_2_1.png') }}" alt="cat-icon">
                                </div>
                                <div class="cat-desc"><span>Đồng hồ</span><span>510 Sản phẩm</span></div>
                            </a></li>
                        <li class="cat-item"><a class="cat-link" data-bs-toggle="tab"
                                href="{{ url('/product_detail') }}tab-cat-3">
                                <div class="cat-icons"><img class="cat-icon"
                                        src="{{ asset('theme/client/assets/images/icons/cat_3.png') }}"
                                        alt="cat-icon"><img class="cat-icon-hover"
                                        src="{{ asset('theme/client/assets/images/icons/cat_3_1.png') }}" alt="cat-icon">
                                </div>
                                <div class="cat-desc"><span>Túi xách</span><span>620 Sản phẩm</span></div>
                            </a></li>
                        <li class="cat-item"><a class="cat-link" data-bs-toggle="tab"
                                href="{{ url('/product_detail') }}tab-cat-4">
                                <div class="cat-icons"><img class="cat-icon"
                                        src="{{ asset('theme/client/assets/images/icons/cat_4.png') }}"
                                        alt="cat-icon"><img class="cat-icon-hover"
                                        src="{{ asset('theme/client/assets/images/icons/cat_4_1.png') }}" alt="cat-icon">
                                </div>
                                <div class="cat-desc"><span>Giày</span><span>320 Sản phẩm</span></div>
                            </a></li>
                    </ul>
    ...
    <section class="section section-space-p" id="vendors">
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="section-title">
                        <h2 class="ec-bg-title">Thương hiệu hàng đầu</h2>
                        <h2 class="ec-title">Thương hiệu hàng đầu</h2>
                        <p class="sub-title">PolyFit - Sự Lựa Chọn Hoàn Hảo Cho Bạn <a
                                href="catalog-multi-vendor.html">Tất cả nhà cung cấp.</a></p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="ec-vendor-card">
                        ...
                        <div class="ec-vendor-prod">
                            <div class="ec-prod-img">
                                <a href="{{ url('/product_detail') }}"><img
                                        src="{{ asset('theme/client/assets/images/product-image/1_1.jpg') }}"
                                        alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="{{ url('/product_detail') }}"><img
                                        src="{{ asset('theme/client/assets/images/product-image/2_1.jpg') }}"
                                        alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="{{ url('/product_detail') }}"><img
                ...
                <div class="col-sm-12 col-md-6 col-lg-3 ec_ven_content" data-animation="zoomIn">
                    <div class="ec-vendor-card">
                        ...
                        <div class="ec-vendor-prod">
                            <div class="ec-prod-img">
                                <a href="{{ url('/product_detail') }}"><img
                                        src="{{ asset('theme/client/assets/images/product-image/5_1.jpg') }}"
                                        alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="{{ url('/product_detail') }}"><img
                            ...
                            <div class="ec-prod-img">
                                <a href="{{ url('/product_detail') }}"><img
                                        src="{{ asset('theme/client/assets/images/product-image/7_1.jpg') }}"
                                        alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="{{ url('/product_detail') }}"><img
                                        src="{{ asset('theme/client/assets/images/product-image/8_1.jpg') }}"
                                        alt="vendor img"></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-sm-12 col-md-6 col-lg-3 ec_ven_content" data-animation="zoomIn">
                    <div class="ec-vendor-card">
                        ...
                        <div class="ec-vendor-prod">
                            <div class="ec-prod-img">
                                <a href="{{ url('/product_detail') }}"><img
                                        src="{{ asset('theme/client/assets/images/product-image/9_1.jpg') }}"
                                        alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="{{ url('/product_detail') }}"><img
                                        src="{{ asset('theme/client/assets/images/product-image/10_1.jpg') }}"
                                        alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="{{ url('/product_detail') }}"><img
                                        src="{{ asset('theme/client/assets/images/product-image/11_1.jpg') }}"
                                        alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="{{ url('/product_detail') }}"><img
                                        src="{{ asset('theme/client/assets/images/product-image/12_1.jpg') }}"
                                        alt="vendor img"></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-sm-12 col-md-6 col-lg-3 ec_ven_content" data-animation="zoomIn">
                    <div class="ec-vendor-card">
                        ...
                        <div class="ec-vendor-prod">
                            <div class="ec-prod-img">
                                <a href="{{ url('/product_detail') }}"><img
                                        src="{{ asset('theme/client/assets/images/product-image/13_1.jpg') }}"
                                        alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="{{ url('/product_detail') }}"><img
                                        src="{{ asset('theme/client/assets/images/product-image/14_1.jpg') }}"
                                        alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="{{ url('/product_detail') }}"><img
                                        src="{{ asset('theme/client/assets/images/product-image/15_1.jpg') }}"
                                        alt="vendor img"></a>
                            </div>
                            <div class="ec-prod-img">
                                <a href="{{ url('/product_detail') }}"><img
                                        src="{{ asset('theme/client/assets/images/product-image/16_1.jpg') }}"
                                        alt="vendor img"></a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    ...
                    <div class="ec-product-ds">
                        <div class="ec-product-image">
                            <a href="{{ url('/product_detail') }}" class="image">
                                <img class="pic-1" src="{{ asset('theme/client/assets/images/product-image/6_1.jpg') }}"
                                    alt="" />
                            </a>
                        </div>
                        <div class="ec-product-body">
                ...
                {{-- <div class="col-lg-3 col-md-6 col-sm-6">
                    ...
                    <div class="ec-product-ds">
                        <div class="ec-product-image">
                            <a href="{{ url('/product_detail') }}" class="image">
                                <img class="pic-1" src="{{ asset('theme/client/assets/images/product-image/3_1.jpg') }}"
                                    alt="" />
                            </a>
