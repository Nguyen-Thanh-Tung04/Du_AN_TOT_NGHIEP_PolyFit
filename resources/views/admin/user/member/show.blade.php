                        ...
                        <div class="row">
                            <div class="col-lg-6 mb-15">
                                <div class="form-row">
                                    ...
                                    <select disabled name="province_id" class="form-control setupSelect2 province location" data-target="districts">
                            ...
                            <div class="col-lg-6 mb-15">
                                <div class="form-row">
                                    ...
                                    <select disabled name="district_id" class="form-control districts setupSelect2 location" data-target="wards">
                        ...
                        <div class="row">
                            <div class="col-lg-6 mb-15">
                                <div class="form-row">
                                    ...
                                    <select disabled name="ward_id" class="form-control setupSelect2 wards">
