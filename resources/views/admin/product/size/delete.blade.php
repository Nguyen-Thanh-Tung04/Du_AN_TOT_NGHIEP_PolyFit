...
@endif
<form action="{{ route('product.size.destroy', $size->id) }}" method="POST" class="box">
    @csrf
    @method('DELETE')
            ...
            <div class="col-lg-5">
                <div class="panel-heading">
                    ...
                    <div class="panel-description">
                        <p>Bạn đang muốn xóa thành viên có tên là: {{ $size->name }}</p>
                    ...
                    <div class="ibox-content">
                        <div class="row">
                            ...
                            <div class="col-lg-6 mb-15">
                                <div class="form-row">
                                    <label class="control-label text-left">Tên kích thước
