...
@endif
@php
    $url = route('product.color.update', $color->id);
@endphp
                    ...
                    <div class="ibox-content">
                        <div class="table-responsive">
                            <table class="table table-sm table-striped table-bordered">
                                <thead>
                                    <tr>
                                        <th>Tên màu sắc<span class="text-danger"> (*)</span></th>
                                    </tr>
                                </thead>
                                <tbody class="variant-tbody">
                                        <tr class="variant-row">
                                            <td class="text-center">
                                                <input type="text" name="name" value="{{ old('name', $color->name) }}" placeholder="Tên màu sắc" class="form-control">
                                            </td>
                                        </tr>
                                </tbody>
                            </table>
