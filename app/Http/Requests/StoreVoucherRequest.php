...
class StoreVoucherRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'value' => 'required|numeric|min:1|' . ($this->input('discount_type') == 'percentage' ? 'max:100' : ''),

            'max_discount_value' => 'nullable|numeric|min:1|required_if:discount_type,percentage',
            'min_order_value' => 'required|numeric|min:1',
            'max_order_value' => 'required|numeric|min:1|gt:min_order_value',
    ...
    public function messages()
    {
        return [
            ...
            'value.max' => 'Giá trị giảm giá không được vượt quá 100% đối với giảm giá phần trăm.',
            ...
            'max_order_value.min' => 'Giá trị đơn hàng tối đa phải lớn hơn 0.',
